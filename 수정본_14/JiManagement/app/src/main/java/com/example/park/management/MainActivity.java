                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success) {
                                ...
                                MainActivity.this.startActivity(intent);
//                                SharedPreferences url = getSharedPreferences("url", Activity.MODE_PRIVATE);
//                                SharedPreferences.Editor editor = url.edit();
//
//                                editor.putString("UnivURL", UnivURL);
//                                editor.putString("DepartURL", DepartURL);
//                                editor.putString("AlpaURL", AlpaURL);
                            } else {
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
...
//                SharedPreferences url = getSharedPreferences("url", Activity.MODE_PRIVATE);
//                String UnivURL = url.getString("UnivURL","");
//                String DepartURL = url.getString("DepartURL","");
//                String AlpaURL = url.getString("UnivURL", "");
////
//                Log.d("Univ",UnivURL + "?????");

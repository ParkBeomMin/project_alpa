...
public class popupDataActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String frag = intent.getStringExtra("board");
...
* */
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(popupDataActivity.this);
                                dialog = builder.setMessage("권한이 없습니다")
                ...
                popupDataActivity.this.startActivity(intent);
    ...
    public void mOnClose(View v){
        ...
        final String userID = intentg.getStringExtra("userID");
